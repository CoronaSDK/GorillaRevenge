...
function new()	
	...
	local jsonLevel = loadValue("level-to-load.data")
	...
	local function callNextLevel()
		...
		timer.performWithDelay(500, director:changeScene("userlevelsfinishedscreen"), 1)
	end
	...
	print(); print("--Printing Current Level--")
	for i=1,table.maxn(levelTable) do
		print("\"" .. levelTable[i] .. "\",") 
	end
	print("--Level Print Finished--");print()
	-------------------------------------------------------------------------------------------------
	-------------------------------------------------------------------------------------------------
