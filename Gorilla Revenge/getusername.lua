...
function new()
	...
	local function drawScreen()
		--
		usernameText = display.newText("To share your levels, a username is required.", 0,0, "helvetica", 20)
		usernameText.x = 240; usernameText.y = 40
		menuGroup:insert(usernameText)
		usernameText2 = display.newText("Please enter a username to continue.", 0,0, "helvetica", 20)
		usernameText2.x = 240; usernameText2.y = 70
		menuGroup:insert(usernameText2)
		usernameText3 = display.newText("(Inappropriate usernames are not acceptable)", 0,0, "helvetica", 14)
